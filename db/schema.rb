...
ActiveRecord::Schema[7.0].define(version: 2025_03_10_141739) do
  ...
  create_table "file_import_logs", force: :cascade do |t|
    t.bigint "file_import_id", null: false
    t.integer "row_number"
    t.string "status", default: "pending", null: false
    t.text "message"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["file_import_id"], name: "index_file_import_logs_on_file_import_id"
    t.index ["status"], name: "index_file_import_logs_on_status"
  end
  ...
  add_foreign_key "file_import_logs", "file_imports"
